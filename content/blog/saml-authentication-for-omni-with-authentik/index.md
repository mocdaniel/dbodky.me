...
description: A short write-up on how to configure SAML authentication for the Kubernetes management portal Omni using Authentik
tags:
  - tutorial
  - omni
  - authentik
...
**DISCLAIMER**: I am not an expert on the SAML authentication protocol, and ended up with my
