---
author: daniel
pubDate: 2023-07-30T12:15:00.000Z
readTime: 11
tags:
  - git
...
<figure>
  ...
  ![Screenshot of Eddie's tweet](../../assets/images/tweet-eddiejaoude.png)
</figure>
...
<figure>
  ...
  ![Screenshot of David's tweet](../../assets/images/tweet-rawkode.png)
</figure>
...
```bash title="Inspecting a signed commit"
...
```bash title="Verifying a commit signed with gitsign"
...
<figure>
  ...
  ![Screenshot of GitHub's 'unverified' badge for a commit signed with gitsign](../../assets/images/gitsign-unverified.png)
...
```bash title="Configuring git to sign commits with SSH keys"
...
```bash title="Configuring git to sign commits with GPG keys"
...
```bash title="Downloading and displaying a GitHub user's GPG keys"
